...
data_file = glob.glob('D:/Users/imbrm/ISIC_2017-2/hehesmall/Validation/*.png')
files = []

#data_file_mask = glob.glob('/home/ck807/melenoma_seg/ISIC-2017_Validation_Part1_GroundTruth/*.png')
data_file_mask = glob.glob('D:/Users/imbrm/ISIC_2017-2/hehesmall/Validation_GT_masks/*.png')
...
#    aa=cv2.addWeighted(a,4,cv2.GaussianBlur(a,(0,0),scale/30),-4,128)*b+128*(1-b)
    ...
    base = os.path.basename("D:/Users/imbrm/ISIC_2017-2/hehesmall/Validation/" + f)
...
for k in (data_file_mask):
    ...
    base = os.path.basename("D:/Users/imbrm/ISIC_2017-2/hehesmall/Validation_GT_masks/" + k)
    fileName = os.path.splitext(base)[0]
